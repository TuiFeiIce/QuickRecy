...
public class Act_HF extends BaseActivity {
    ...
    private void initListener() {
        ...
        hfAdapter = new HFAdapter<String>(stringList) {
            @Override
            public int getLayoutId(int viewType) {
                if (viewType == HFAdapter.HEAD) {
                    return R.layout.include_control_head;
                } else if (viewType == HFAdapter.BODY) {
                    return R.layout.recy_content;
                } else if (viewType == HFAdapter.FOOT) {
            ...
            @Override
            public void convert3(VHFoot holder) {
        ...
        hfAdapter.setOnItemClickListener(new OnItemClickListener() {
            @Override
            public void OnItemClick(View view, Integer integer) {
                Toast.makeText(context, "" + integer, Toast.LENGTH_SHORT).show();
            }
        });
        hfAdapter.setOnLongClickListener(new OnLongClickListener() {
            @Override
